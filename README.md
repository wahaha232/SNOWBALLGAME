...
- 角色與雪球皆由程式即時繪製（無需依賴 sprites 也能玩），造型比照經典打雪仗遊戲的尖帽小人設計
...
- 支援 PWA（可安裝到手機主畫面）
- 網頁外觀走 1990~2000 年代懷舊風格（跑馬燈、立體浮雕邊框、README.TXT 說明區塊），遊戲畫面置中於頁面，下方附完整操作說明
- 支援中文／英文介面切換（右上角按鈕），選擇會記住在瀏覽器本機（localStorage）
- 敵人雪球速度會隨關卡漸進加快（第1關明顯較慢好躲，之後逐關提升），瞄準準確度也隨關卡提升
